...
export const metadata = pageMetadata("/take-home-30", "手取り30万円の一人暮らし｜家賃・生活費の予算例", "手取り30万円の家賃割合と生活費の組み合わせを計算例で紹介。毎月残るお金を確認し、無料シミュレーターで自分の条件に変更できます。平均額や貯金額の保証ではありません。");
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-4 text-right">2万円</td>
                  </tr>
                </tbody>
              </table>
            </div>
