...
export const metadata = pageMetadata("/take-home-40", "手取り40万円の一人暮らし｜家賃・生活費の予算例", "手取り40万円の家賃割合と生活費の組み合わせを計算例で紹介。毎月残るお金を確認し、無料シミュレーターで自分の条件に変更できます。平均額や貯金額の保証ではありません。");
