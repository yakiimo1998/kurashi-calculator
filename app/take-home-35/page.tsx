...
export const metadata = pageMetadata("/take-home-35", "手取り35万円の一人暮らし｜家賃・生活費の予算例", "手取り35万円の家賃割合と生活費の組み合わせを計算例で紹介。毎月残るお金を確認し、無料シミュレーターで自分の条件に変更できます。平均額や貯金額の保証ではありません。");

export default function TakeHome35Page() {
  return (
...
<aside className="article-note">この記事の金額は、当サイトが設定した家計の計算例です。統計上の平均・推奨額ではありません。年間の残額は同じ条件が12か月続く仮定で、入力例に含まれない臨時支出や賞与は反映していません。</aside>
          ...
          <p className="mt-5 leading-7 text-gray-700">
            手取り35万円で一人暮らしをする場合、家賃はいくらまでにするとよいのでしょうか。
          ...
          <section className="mt-8">
            ...
            <p className="mt-4 text-sm leading-6 text-gray-600">
              ※実際に確保できる家賃は、住んでいる地域、通勤費、車の有無、趣味や貯金額などによって変わります。
            </p>
          </section>
      ...
      <p className="mt-4 font-semibold text-blue-600">
        車の費用を計算する →
          ...
          <section className="mt-10">
            ...
            <p className="mt-4 leading-7 text-gray-700">
              家賃や食費などを自分の条件に変更して、一人暮らしの生活費と毎月残るお金を計算できます。
            </p>
