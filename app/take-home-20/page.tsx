...
export const metadata = pageMetadata("/take-home-20", "手取り20万円の一人暮らし｜家賃・生活費の予算例", "手取り20万円の家賃割合と生活費の組み合わせを計算例で紹介。毎月残るお金を確認し、無料シミュレーターで自分の条件に変更できます。平均額や貯金額の保証ではありません。");
...
<aside className="article-note">この記事の金額は、当サイトが設定した家計の計算例です。統計上の平均・推奨額ではありません。年間の残額は同じ条件が12か月続く仮定で、入力例に含まれない臨時支出や賞与は反映していません。</aside>
  ...
  <p className="mt-4 leading-7 text-gray-700">
    上記の生活費を例にすると、手取り20万円から生活費15万円を引いた場合、
    毎月5万円が残ります。
  </p>
